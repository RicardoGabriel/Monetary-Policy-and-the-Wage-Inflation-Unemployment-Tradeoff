% matrix: C file: C:\Users\Ricardo\Documents\GitHub\Monetary-Policy-and-the-Wage-Inflation-Unemployment-Tradeoff\Output\Tables\Correlation_Wage_Fix.tex  19 Apr 2023 19:36:34
\begin{table}[htbp]
\caption{\label{T_Correlation} Wage Inflation Correlations Table}\centering\medskip
\begin{tabular}{lccc} \hline \hline
 & $\pi_t^p$  & $\pi_{t-1}^p$  & $  \\  \hline 
