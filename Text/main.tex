...
The choice of the 2\% threshold can be rationalized by the inflation target strategy of many of the central banks present in the analyzed sample. Over the last 20 years of the sample, most central banks were targeting inflation either implicitly or explicitly (Table \ref{T_HistoricalPeriodsSource1}). Most of them disclaimed that their goal was to achieve inflation close to or below 2\%. With such a sample division, I am assigning 75\% of the sample to the high-inflation state and 25\% to the low-inflation state as summarized in Figure \ref{F:Sample_SD}.
