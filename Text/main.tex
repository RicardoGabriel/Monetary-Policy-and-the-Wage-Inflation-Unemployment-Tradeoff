...
For this first exercise, I identified different monetary policy regimes as described in Appendix \ref{SS_HistoricalPeriods} and summarized in Table \ref{T_HistoricalPeriodsSource1}. I then add a Monetary Policy regime dummy when estimating equations \eqref{EQ:MULT} and \eqref{EQ:MULT_State} to capture structural differences that are common across countries in the same MP regime. Results... 
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.6]{../Output/Figures/history_Sample}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.6]{../Output/Figures/history_Sample_SD}
    \annote{\footnotesize This figure displays which year-country observations are being used when estimating the Phillips Multiplier for the matched sample.}
    \label{F:Sample}
\end{figure}
