...
In Appendix, Figure \ref{F:MultiplierQ} replicates Figure \ref{F:Multiplie} using this new data. Compared to the baseline, Figure \ref{F:MultiplierQ} displays a smaller multiplier and a much weaker average wage inflation response.
