...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.9]{../Output/Figures/history_Sample}
    \annote{\footnotesize This figure displays which year-country observations are being used when estimating the Phillips Multiplier.}
    \label{F:Sample}
\end{figure}
